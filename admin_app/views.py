...
#         data = UserSignup.objects.get(userEmail=request.session['email'])
#         if check_password(cupass, data.userPassword):
#             if conpass == npass:
#         # opass=email_id.userPassword
#         # auth = check_password(cpass,opass)
#         # auth2 = check_password(apass,npass)
#         # if auth==True and auth2==True:
#                 up = UserSignup(userEmail=request.session['email'],userPassword=make_password(npass))
